...
class NoteApi {
  Future<List<Note>> getAllNote() async {
    // print('Pertama Jalan');
    final uri = Uri.parse(
        'https://notes-6e0d0-default-rtdb.asia-southeast1.firebasedatabase.app/notes.json');
    ...
    try {
      ...
      throw Exception('ErroDr, Terjadi Kesalahan');
    }
    return notes;
  }
  ...
  Future<void> updateNote(Note note) async {
    final uri = Uri.parse(
        'https://notes-6e0d0-default-rtdb.asia-southeast1.firebasedatabase.app/notes/${note.id}.json');
  ...
  Future<void> toggleIsPinned(
    ...
    final uri = Uri.parse(
        'https://notes-6e0d0-default-rtdb.asia-southeast1.firebasedatabase.app/notes/${id}.json');
